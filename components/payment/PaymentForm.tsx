...
export default function PaymentForm(props) {
  ...
  return (
    <>
      ...
      {/* End if the transaction status is pending */}

      {/* If the transaction status is approved */}
      {transactionStatus === "approved" && <PaymentApproved {...props} />}
      {/* End the transaction status is approved */}

      {/* If the transaction status is declined */}
      {transactionStatus === "declined" && <PaymentDeclined {...props} />}
      {/* End the transaction status is declined */}
    </>
  );
}
